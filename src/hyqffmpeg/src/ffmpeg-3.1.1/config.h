...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg --enable-shared --enable-gpl --enable-libx264 --enable-libmp3lame"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/usr/local/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg/share/ffmpeg"
